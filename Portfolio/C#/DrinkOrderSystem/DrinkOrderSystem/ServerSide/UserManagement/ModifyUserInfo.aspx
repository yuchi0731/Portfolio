                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <table>
                            ...
                            <tr>
                                <td>
                                    <asp:Button ID="btnUpdate" runat="server" Text="修改" CommandArgument='<%#Eval("Account") %>' CommandName="btnModify" onclientclick="javascript:return confirm('即將變更資料，繼續請按確定');" />
                                    <asp:Button ID="btnClear" runat="server" Text="取消變更" CommandName="btnClear" onclientclick="javascript:return confirm('取消將不保留資料，繼續請按確定');" /><br />
                                </td>
                            </tr>
