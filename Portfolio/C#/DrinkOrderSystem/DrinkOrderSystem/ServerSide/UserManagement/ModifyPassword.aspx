...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <asp:Button ID="btnChange" runat="server" Text="確認變更" onclientclick="javascript:return confirm('即將變更密碼，繼續請按確定');" OnClick="btnChange_Click" />
    <asp:Button ID="btnCancel" runat="server" Text="取消變更" onclientclick="javascript:return confirm('取消變更將導回使用者清單頁，繼續請按確定');" OnClick="btnCancel_Click" />
    <br />
