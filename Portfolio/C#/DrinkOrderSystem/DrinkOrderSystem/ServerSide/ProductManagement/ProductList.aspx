...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <asp:GridView ID="gvProduct" runat="server" AutoGenerateColumns="False" OnRowCommand="gvProduct_RowCommand" OnRowDataBound="gvProduct_RowDataBound">
        <Columns>
            ...
            <asp:TemplateField HeaderText="參考圖片">
                <ItemTemplate>
                    <asp:ImageButton ID="imgPictrue" runat="server" Visible="false" Width="35" Height="45" CommandName="btnLarger" />
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="刪除">
                <ItemTemplate>
                    <asp:Button ID="btnDelete" runat="server" Text="刪除" class="btn btn-info" onclientclick="javascript:return confirm('若刪除資料將無法復原，繼續請按確定');" CommandName="btndelete" CommandArgument='<%#Eval("ProductID") %>' />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
