...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <asp:Button ID="btnDelete" runat="server" Text="取消跟團" OnClientClick="javascript:return confirm('取消將不會儲存資料，請按確認繼續');" OnClick="btnDelete_Click" Visible="False" class="btn btn-warning" /><br />
