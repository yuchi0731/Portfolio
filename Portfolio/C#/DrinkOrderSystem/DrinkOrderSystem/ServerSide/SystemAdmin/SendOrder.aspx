...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <asp:Button runat="server" ID="btnExport" Text="送出訂購單並寄信" class="btn btn-primary" OnClick="btnExport_Click" Visible="false" />
    <asp:Button runat="server" ID="btnCancel" Text="取消" onclientclick="javascript:return confirm('即將取消訂單，繼續請按確認');" OnClick="btnCancel_Click" Visible="false" class="btn btn-warning" />
