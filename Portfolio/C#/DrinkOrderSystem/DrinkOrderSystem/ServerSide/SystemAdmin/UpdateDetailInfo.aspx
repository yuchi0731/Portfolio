                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                ...
                                【<asp:Label ID="lbAmount" runat="server" Text='<%# Eval("SubtotalAmount") %>'></asp:Label>】元
                                <br />
                            </td>
                            <td></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnCancel" runat="server" class="btn btn-outline-secondary" onclientclick="javascript:return confirm('尚有未儲存資料，繼續請按確定');" Text="取消變更" CommandName="btnCancel" />
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
