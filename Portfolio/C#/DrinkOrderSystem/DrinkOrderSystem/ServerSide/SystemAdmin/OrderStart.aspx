...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <h4 class="gd" id="gd1">
        <asp:Literal ID="ltChoosedShop" runat="server">請點圖片來選擇店家</asp:Literal></h4>
    <div id="d1">
    ...
    <div id="gdlist">
        <h4 class="gd" id="gd2">
            <asp:Literal ID="ltDrinkTitle" runat="server" Visible="false">請選擇飲料品項</asp:Literal></h4>
    ...
    <div>
        ...
        <asp:Button ID="btnDelete" runat="server" Text="取消開團" OnClientClick="javascript:return confirm('取消將不會儲存資料，請按確認繼續');" OnClick="btnDelete_Click" Visible="False" />
    </div>
